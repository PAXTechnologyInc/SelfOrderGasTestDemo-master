...
public interface ITabView {
    ...
    class TabIcon {
        ...
        public Bitmap getSelectedIconBitmap() {
            return mBuilder.mSelectedBitmap;
        }

        public Bitmap getNormalIconBitmap() {
            return mBuilder.mNormalBitmap;
        }

        public String getSelectedIconUrl() {
            return mBuilder.mSelectedUrl;
        }

        public String getNormalIconUrl() {
            return mBuilder.mNormalUrl;
        }
        ...
        public static class Builder {
            ...
            public Builder setIcon(Bitmap selectIconBitmap, Bitmap normalIconBitmap) {
                mSelectedBitmap = selectIconBitmap;
                mNormalBitmap = normalIconBitmap;
                return this;
            }

            public Builder setIcon(String selectIconUrl, String normalIconUrl) {
                mSelectedUrl = selectIconUrl;
                mNormalUrl = normalIconUrl;
                return this;
            }
    ...
    class TabTitle {
        ...
        public static class Builder {
            ...
            public Builder setTextBold(boolean bold) {
                mBold = bold;
                return this;
            }
