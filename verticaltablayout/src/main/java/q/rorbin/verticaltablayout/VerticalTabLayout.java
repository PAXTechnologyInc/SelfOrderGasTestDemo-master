...
public class VerticalTabLayout extends ScrollView {
    ...
    private boolean mTabInterceptTouch = false;
    ...
    public void setTabInterceptTouch(boolean b) {
        mTabInterceptTouch = b;
    }
...
//    }
    ...
    public void setupWithFragment(FragmentManager manager, int containerResid, List<Fragment> fragments) {
        System.out.println("VerticalTabLayoutSetupWithFragment called");
        if (mTabFragmentManager != null) {
            mTabFragmentManager.detach();
        }
        if (containerResid != 0) {
            System.out.println("TabFragmentManager created");
